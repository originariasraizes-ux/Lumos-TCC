...
<head>
  ...
  <title>Ciências Humanas e Letras</title>

  <link rel="stylesheet" href="/Lumos-TCC-main/css/CienciasHumanas.css">
...
<div class="onda">
 ...
 <header class="header">
    ...
    <img src="/Lumos-TCC-main/images/Logos/LumosHumanasLetras.png" width="180px">
    </a>
  ...
  <section class="Explorando">
    ...
    <div class="lado-esquerdo">
      <div class="texto-explorando">
        <h1 class="league-spartan">Explorando o Mundo das Ciências Humanas e Letras</h1>
    ...
    <div class="img-explorando">
      <img src="/Lumos-TCC-main/images/jogos/humanass.gif" alt="Imagem Explorando">
    </div>
