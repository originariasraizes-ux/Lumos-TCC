...
<head>
  ...
  <link rel="stylesheet" href="/Lumos-TCC-main/css/CienciasExatas.css">
...
<div class="onda">
 ...
 <header class="header">
    ...
    <img src="/Lumos-TCC-main/images/Logos/LumosExatas.png" width="180px">
    </a>
  ...
  <section class="Explorando">
    ...
    <div class="lado-esquerdo">
      <div class="texto-explorando">
        <h1 class="league-spartan">Explorando o Mundo de Exatas</h1>
    ...
    <div class="img-explorando">
      <img src="/Lumos-TCC-main/images/jogos/gif exatas.gif" alt="Imagem Explorando">
    </div>
